...
import config
from controllers import health_controller, emotion_detection_controller, avatar_controller, webm_wav_controller
...
def app_factory() -> FastAPI:
    ...
    app.include_router(webm_wav_controller.router, prefix="/api/v1/webm-wav")
